-- =============================================================================
-- 0004_seed_allergens_and_food_items.sql
-- Poblado exactamente desde knowledge/allergens/efsa-14.md y
-- knowledge/foods/starter-catalog.md. No editar aquí sin actualizar
-- primero el archivo de knowledge/ correspondiente (RULES.md #11).
-- =============================================================================

insert into allergens (slug, name, source_id) values
...
insert into food_items (name, category, min_age_days, source_id) values
...
insert into food_allergens (food_item_id, allergen_id)
select f.id, a.id from food_items f, allergens a
